...
pub struct Player {
	...
	pub hole_completion_state: CompletionState,
...
impl Player {
    pub fn new() -> Self {
        Player {
            ...
            hole_completion_state: CompletionState::_________,
    ...
    pub fn start_game(&mut self) {
        self.hole_completion_state = CompletionState::_________;
...
impl Party {
    ...
    pub fn get_main_player(&self) -> Player {
        ...
        // Get the local main player (Arc<Mutex<Player>>)
    ...
    pub fn get_active_player_entity(&self) -> Player {
        let active_player = *self.active_player.lock().unwrap();
        ...
        // Get the active player (Arc<Mutex<Player>>)
        let player_arc = &players_lock[active_player as usize];
