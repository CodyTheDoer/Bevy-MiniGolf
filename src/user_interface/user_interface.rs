...
pub fn easy_vec_ui(
    ...
    let dedicated_left_data_vec = vec![
        ...
        String::from(format!("KeyC: cycle_camera,   KeyP: cycle_active_player")),
    ...
    let right_data_vec = vec![
        ...
        String::from(format!("purge_handler: Environment Purged: [{:?}]", purge_handler.get(CheckStatePH::EnvironmentPurged))),
        String::from(format!("purge_handler: Golf Balls Purged: [{:?}]", purge_handler.get(CheckStatePH::GolfBallsPurged))),
        String::from(format!("______________________________________________________________________")),
        String::from(format!("add_physics_query_and_update_scene: {:?}", run_trigger.get(CheckStateRT::AddPhysicsQueryAndUpdateScene))),
        String::from(format!("______________________________________________________________________")),
        String::from(format!("camera_handler_cycle_state_camera: {:?}", run_trigger.get(CheckStateRT::CameraHandlerCycleStateCamera))),
        String::from(format!("______________________________________________________________________")),
        String::from(format!("game_handler_game_start: {:?}", run_trigger.get(CheckStateRT::GameHandlerGameStart))),
        String::from(format!("game_handler_game_state_exit_routines: {:?}", run_trigger.get(CheckStateRT::GameHandlerGameStateExitRoutines))),
        String::from(format!("game_handler_game_state_start_routines: {:?}", run_trigger.get(CheckStateRT::GameHandlerGameStateStartRoutines))),
        String::from(format!("game_handler_start_local_back_nine: {:?}", run_trigger.get(CheckStateRT::GameHandlerStartLocalBackNine))),
        String::from(format!("game_handler_start_local_front_nine: {:?}", run_trigger.get(CheckStateRT::GameHandlerStartLocalFrontNine))),
        String::from(format!("game_handler_start_local_select_a_hole: {:?}", run_trigger.get(CheckStateRT::GameHandlerStartLocalSelectAHole))),
        String::from(format!("game_handler_start_local_whole_course: {:?}", run_trigger.get(CheckStateRT::GameHandlerStartLocalWholeCorse))),
        String::from(format!("game_handler_start_local_tutorial: {:?}", run_trigger.get(CheckStateRT::GameHandlerStartTutorial))),
        String::from(format!("______________________________________________________________________")),
        String::from(format!("golf_ball_handler_end_game: {:?}", run_trigger.get(CheckStateRT::GolfBallHandlerEndGame))),
        String::from(format!("golf_ball_handler_party_store_locations: {:?}", run_trigger.get(CheckStateRT::GolfBallHandlerPartyStoreLocations))),
        String::from(format!("golf_ball_handler_reset_golf_ball_locations: {:?}", run_trigger.get(CheckStateRT::GolfBallHandlerResetGolfBallLocations))),
        String::from(format!("golf_ball_handler_spawn_golf_balls_for_party_members: {:?}", run_trigger.get(CheckStateRT::GolfBallHandlerSpawnGolfBallsForPartyMembers))),
        String::from(format!("golf_ball_handler_update_locations_post_bonk: {:?}", run_trigger.get(CheckStateRT::GolfBallHandlerUpdateLocationsPostBonk))),
        String::from(format!("______________________________________________________________________")),
        String::from(format!("leader_board_log_game: {:?}", run_trigger.get(CheckStateRT::LeaderBoardLogGame))),
        String::from(format!("leader_board_review_last_game: {:?}", run_trigger.get(CheckStateRT::LeaderBoardReviewLastGame))),
        String::from(format!("______________________________________________________________________")),
        String::from(format!("level_handler_init_level_game_handler_current_level: {:?}", run_trigger.get(CheckStateRT::LevelHandlerInitLevelGameHandlerCurrentLevel))),
        String::from(format!("level_handler_next_turn_protocol: {:?}", run_trigger.get(CheckStateRT::LevelHandlerNextTurnProtocol))),
        String::from(format!("level_handler_purge_protocol: {:?}", run_trigger.get(CheckStateRT::LevelHandlerPurgeProtocol))),
        String::from(format!("level_handler_set_state_next_level: {:?}", run_trigger.get(CheckStateRT::LevelHandlerSetStateNextLevel))),
        String::from(format!("level_handler_set_state_next_map_set: {:?}", run_trigger.get(CheckStateRT::LevelHandlerSetStateNextMapSet))),
        String::from(format!("______________________________________________________________________")),
        String::from(format!("network_get_client_state_all: {:?}", run_trigger.get(CheckStateRT::NetworkGetClientStateAll))),
        String::from(format!("network_get_client_state_game: {:?}", run_trigger.get(CheckStateRT::NetworkGetClientStateGame))),
        String::from(format!("______________________________________________________________________")),
        String::from(format!("party_handler_active_player_add_bonk: {:?}", run_trigger.get(CheckStateRT::PartyHandlerActivePlayerAddBonk))),
        String::from(format!("party_handler_active_player_set_hole_completion_state_true: {:?}", run_trigger.get(CheckStateRT::PartyHandlerActivePlayerSetHoleCompletionStateTrue))),
        String::from(format!("party_handler_cycle_active_player: {:?}", run_trigger.get(CheckStateRT::PartyHandlerCycleActivePlayer))),
        String::from(format!("party_handler_new_player_ai: {:?}", run_trigger.get(CheckStateRT::PartyHandlerNewPlayerAi))),
        String::from(format!("party_handler_new_player_local: {:?}", run_trigger.get(CheckStateRT::PartyHandlerNewPlayerLocal))),
        String::from(format!("party_handler_new_player_remote: {:?}", run_trigger.get(CheckStateRT::PartyHandlerNewPlayerRemote))),
        String::from(format!("party_handler_remove_ai: {:?}", run_trigger.get(CheckStateRT::PartyHandlerRemoveAi))),
        String::from(format!("party_handler_remove_last_player: {:?}", run_trigger.get(CheckStateRT::PartyHandlerRemoveLastPlayer))),
        String::from(format!("party_handler_remove_local_player: {:?}", run_trigger.get(CheckStateRT::PartyHandlerRemoveLocalPlayer))),
        String::from(format!("______________________________________________________________________")),
        String::from(format!("turn_handler_end_game: {:?}", run_trigger.get(CheckStateRT::TurnHandlerEndGame))),
        String::from(format!("turn_handler_next_round_prep: {:?}", run_trigger.get(CheckStateRT::TurnHandlerNextRoundPrep))),
        String::from(format!("turn_handler_set_turn_next: {:?}", run_trigger.get(CheckStateRT::TurnHandlerSetTurnNext))),
        String::from(format!("______________________________________________________________________")),
        String::from(format!("start_movement_listener_turn_handler_set_next_turn: {:?}", run_trigger.get(CheckStateRT::StartMovementListenerTurnHandlerSetTurnNext))),
    ];
